<nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                class="<?php echo urlIs('index.php') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?> rounded-md px-3 py-2 text-sm font-medium">
                Home
                </a>

                <a href="about.php"
                class="<?php echo urlIs('about.php') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?> rounded-md px-3 py-2 text-sm font-medium">
                About
                </a>

                <a href="contact.php"
                class="<?php echo urlIs('contact.php') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?> rounded-md px-3 py-2 text-sm font-medium">
                Contact
                </a>
